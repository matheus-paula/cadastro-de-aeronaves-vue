  ...
  <div>
    <div class="container">
      ...
      <div class="row w-75 m-auto">
        <ul class="nav nav-tabs" style="width:90%;margin-left:10px;" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="add-aircrafts-tab" data-bs-toggle="tab" data-bs-target="#add-aircrafts" type="button" role="tab" aria-controls="add-aircrafts" aria-selected="true">Adicionar Aeronaves</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="search-tab" data-bs-toggle="tab" data-bs-target="#search" type="button" role="tab" aria-controls="search" aria-selected="false">Pesquisar Aeronaves</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="statistics-tab" data-bs-toggle="tab" data-bs-target="#statistics" type="button" role="tab" aria-controls="statistics" aria-selected="false">Estatísticas</button>
          </li>
        </ul>
        <div style="margin-top:-1px;" class="p-4 align-items-center rounded-3 border shadow-lg">
